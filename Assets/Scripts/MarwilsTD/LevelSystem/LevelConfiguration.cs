...
namespace MarwilsTD.LevelSystem
{
    ...
    /// </summary>
    public class LevelConfiguration : TimeElement
    {
        [SerializeField]
        ...
        private List<RouteConfiguration> _routes = new();
        public IReadOnlyList<RouteConfiguration> Routes => _routes;

        [SerializeField]
        [Tooltip("List of waves in the level.")]
        private List<WaveConfiguration> _waves = new();
        public List<WaveConfiguration> Waves => _waves;
        ...
        private void OnValidate()
        {
            ...
            if (_waves == null)
            {
                _waves = new List<WaveConfiguration>();
            }
