...
namespace LevelSystem
{
    ...
    public abstract class KeepTargetStrategy
    {
        ...
        public abstract bool ShouldKeepTarget(global::Enemy currentTarget, bool hasAttacked, bool hasTakenDamage);
    }

    [Serializable]
    public class AlwaysKeepTargetStrategy : KeepTargetStrategy
    {
        public override bool ShouldKeepTarget(global::Enemy currentTarget, bool hasAttacked, bool hasTakenDamage)
        {
